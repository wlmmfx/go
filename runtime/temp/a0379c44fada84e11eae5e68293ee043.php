<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:88:"D:\wamp64\www\thinkphp5-study-line\public/../application/backend\view\article\index.html";i:1503714957;s:81:"D:\wamp64\www\thinkphp5-study-line\public/../application/backend\view\layout.html";i:1499682479;s:86:"D:\wamp64\www\thinkphp5-study-line\public/../application/backend\view\common\head.html";i:1503715399;s:88:"D:\wamp64\www\thinkphp5-study-line\public/../application/backend\view\common\navbar.html";i:1501396682;s:89:"D:\wamp64\www\thinkphp5-study-line\public/../application/backend\view\common\sidebar.html";i:1502505923;s:88:"D:\wamp64\www\thinkphp5-study-line\public/../application/backend\view\common\footer.html";i:1501769162;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                ...
                <div id="category-add" class="tab-pane left">
                    <form action="<?php echo url('/backend/article/store'); ?>" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-2"> 所属栏目</label>

                            <div class="col-sm-9">
                                <select name="cate_id" id="cate_id">
                                    <?php if(is_array($categorys) || $categorys instanceof \think\Collection || $categorys instanceof \think\Paginator): $i = 0; $__LIST__ = $categorys;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <option value="<?php echo $vo['id']; ?>"><?php echo $vo['_name']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-3"> 标签</label>
                            ...
                            <div class="col-sm-9">
                                <label class="middle">
                                    ...
                                    <input class="ace" type="checkbox" name="tag[]" value="<?php echo $vo['id']; ?>" id="tag" />
                                    <span class="lbl"> <?php echo $vo['name']; ?></span>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </label>
                            </div>
                        </div>
...
var ue = UE.getEditor('editor',{
    ...
    serverUrl:"<?php echo url('/backend/article/saveinfo'); ?>"
});
